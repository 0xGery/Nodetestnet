...
if [ ! $ApiURL ]; then
	read -p "Masukin API URLmu: " ApiURL
	echo 'export Address='$ApiURL >> $HOME/.bash_profile
fi

source $HOME/.bash_profile

echo '================================================='
echo -e "API URL: \e[1m\e[32m$ApiURL\e[0m"
echo '================================================='
...
echo -e "\e[1m\e[32m1. Installing Essential package... \e[0m" && sleep 1
sudo apt-get install -y pkg-config curl git build-essential libssl-dev screen

echo -e "\e[1m\e[32m1. Cloning pathfinder... \e[0m" && sleep 1
git clone --branch v0.4.0 https://github.com/eqlabs/pathfinder.git

echo -e "\e[1m\e[32m1. Creating pathfinder folder... \e[0m" && sleep 1
mkdir -p $HOME/pathfinder

echo -e "\e[1m\e[32m1. Running Docker... \e[0m" && sleep 1
docker run -d \
  --rm \
  -p 9545:9545 \
  --user "$(id -u):$(id -g)" \
